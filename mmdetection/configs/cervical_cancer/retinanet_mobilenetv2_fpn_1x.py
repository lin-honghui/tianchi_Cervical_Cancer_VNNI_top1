...
train_pipeline = [
    ...
    dict(type='CervicalCancerCrop', crop_size=crop_size),
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'RoiLabel',
        img_prefix=data_root + 'RoiImage',
...
# work_dir = './work_dirs/cervical_cancer/retinanet_mobilenetv2_fpn_1x/6_crop1600_resize800'
